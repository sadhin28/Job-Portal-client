...
const Hotjob = ({job}) => {
    ...
    return (
      ...
      {/* CTA Button */}
      <div className="mt-6">
        <Link to={`jobdetails/${_id}`} className="w-full flex justify-center items-center gap-3 bg-gradient-to-r  from-indigo-500 via-purple-500 to-pink-500 ... hover: text-white font-semibold py-2 rounded-xl transition duration-300">
           <FaEye></FaEye>
           View Details
        </Link>
      </div>
